...
const SURFACES = [
  ...
  { route: "/blog/", name: "index card title", selector: "main a[href^='/blog/'] h2" },
  { route: "/blog/", name: "index card subtitle", selector: "main a[href^='/blog/'] h2 + p" },
  {
    route: "/blog/",
    name: "index card tag chip",
    selector: "main a[href^='/blog/'] [class*='border-primary/20']",
  },
