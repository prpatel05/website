...
There's now real data on how these systems fail. A team from Berkeley and collaborators hand-annotated [more than 1,600 execution traces](https://arxiv.org/abs/2503.13657) across seven popular multi-agent frameworks and built a taxonomy of what actually goes wrong. They found fourteen distinct failure modes, with high agreement between annotators, sorted into three buckets: system design issues, inter-agent misalignment, and task verification.
