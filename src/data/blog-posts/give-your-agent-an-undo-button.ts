...
export const giveYourAgentAnUndoButton: BlogPost = {
  slug: "give-your-agent-an-undo-button",
  title: "Give Your Agent an Undo Button",
  subtitle:
  ...
  image: "/images/blog-give-your-agent-an-undo-button.webp",
  content: `In April 2026, an AI coding agent [deleted a company's production database in nine seconds](https://www.euronews.com/next/2026/04/28/an-ai-agent-deleted-a-companys-entire-database-in-9-seconds-then-wrote-an-apology), then wrote an apology.
