...
const Index = () => {
  return (
    <PageShell jumpRail terminal>
      <SEO
        title={HOME_TITLE}
        description="Technology executive and 3x company builder with 11+ years scaling engineering orgs across AI, Cloud, and Web3. Currently Chief Architect at Bounded · OpenApps."
