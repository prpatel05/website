...
/**
 * Sitewide tiny mono sitemap. Shared so blog / series / post / 404 / home do
 * not each invent a footer. RSS and llms.txt are visible here — not only in
 * `<head>` — so a reader (or an agent) can find them without viewing source.
 */
const SiteFooter = () => {
